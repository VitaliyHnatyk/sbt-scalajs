...
object Dependencies {
   ...
   */
  val sclalajsQuery = Seq(libraryDependencies += "org.scala-lang.modules.scalajs" %%% "scalajs-jquery" % "0.6")


  /**
   * uTest
   * Make sure that the uTest plugin is enabled in project/plugîns.sbt
   * @see https://github.com/lihaoyi/utest 
   */
  val uTest = Seq(libraryDependencies += "com.lihaoyi" %%% "utest" % "0.2.4")

  //TODO: add more from http://www.scala-js.org/
}
